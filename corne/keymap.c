...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT_split_3x6_3(
                    ...
                    KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B,                      KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO,
                                          KC_TAB, KC_BSPC, MO(1),       MO(2), KC_SPC, TD(TD_ENT_ESC)),
...
[_LOWER] = LAYOUT_split_3x6_3(
                  ...
                  KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,                 KC_VOLD, KC_VOLU, KC_MUTE, KC_NO, KC_QUOTE, KC_NO, 
                                      KC_LGUI, KC_DEL, KC_TRNS,         KC_ENT, MO(3), KC_RALT),

[_RAISE] = LAYOUT_split_3x6_3(

                  KC_TAB, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,            KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, 
                  KC_LCTL, KC_QUOTE, KC_INS, KC_NO, KC_NO, KC_NO,                 KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_GRV,
